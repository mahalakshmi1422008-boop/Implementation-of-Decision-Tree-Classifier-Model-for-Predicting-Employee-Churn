...
## Algorithm:
1.Collect and prepare the dataset with employee features and churn label, then separate inputs (X) and target (y).
...
4.Predict results on the test data and evaluate using accuracy, confusion matrix, and classification report.

5.Visualize the decision tree and predict churn for a new employee record.
## Program:
```
/*
...
## Output:
<img width="861" height="609" alt="Screenshot 2026-02-24 091657" src="https://github.com/user-attachments/assets/c30f84ae-9551-4acd-a4c1-b8f1e2b69335" />
<img width="1157" height="813" alt="Screenshot 2026-02-24 091715" src="https://github.com/user-attachments/assets/59e828da-e63f-4e06-88c6-29ab32508ff9" />
